...
echo "SKIPPING THE Compiling and install of display driver..."
#cd ~/
...
cd ~/bbqX0kbd_driver
make || { echo "Error: Failed to compile driver."; exit 1; }
sudo make install || { echo "Error: Failed to 'make install' driver."; exit 1; }
